...
export default function JobsFeed(){
    ...
    const [apply, setApply] = useState("apply_for_jobs_deactivated");
    const [applied, setApplied] = useState("applied_deactivated");
    ...
    function jobApplyingFunction(){
        if(apply==="apply_for_jobs_activated"){
            setApply("apply_for_jobs_deactivated");
        }
        else{
            setApply("apply_for_jobs_activated");
            setApplied("applied_deactivated");
        }
    }

    function appliedFunction(){
        if(applied==="applied_activated"){
            setApplied("applied_deactivated")
        }
        else{
            setApplied("applied_activated");
            setApply("apply_for_jobs_deactivated");
        }
    }
    return(
        <div className="jobs_feed">
            ...
            <div id="jobs_feed_bottom">
                ...
                <div className="Jobs_feed_recommendation" >
                    ...
                    <div className="company_details">
                        <p className="designation" onClick={jobApplyingFunction}>Remote technical support</p>
                ...
                <div className="Jobs_feed_recommendation">
                    ...
                    <div className="company_details">
                        <p className="designation" onClick={jobApplyingFunction}>Cloud Development Application Developer</p>
                ...
                <div className="Jobs_feed_recommendation">
                    ...
                    <div className="company_details">
                        <p className="designation" onClick={jobApplyingFunction}>Process Developer</p>
            ...
            <div className={apply}>
                <div className="apply_for_jobs">
                    <h1>Do you want to apply?</h1>
                    <div className="apply_buttons">
                        <button onClick={appliedFunction}>Yes</button>
                        <button onClick={jobApplyingFunction}>No</button>
                    </div>
                    
                </div>
            </div>
            <div className={applied}>
                <div className="applied_popup">
                    <AiFillCheckCircle className="appled_job_check_mark"></AiFillCheckCircle>
                    <p>You have applied for this job</p>
                    <AiOutlineClose className="applied_job_close" onClick={appliedFunction}></AiOutlineClose>
                </div>
            </div>
